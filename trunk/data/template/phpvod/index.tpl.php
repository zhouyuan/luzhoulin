...
<div class="box_content box_caption_w720">
<table class="table box_caption_w720 " >
...
<td width="10%">评论数</td>
<td width="10%">审核</td>
</tr><? $n=1; $videodb = pv_loop('video',"cid=$c1[cid]|showsub=1|order=lostdate DESC,postdate DESC|limit=16|subject_len=22"); if(is_array($videodb)) { foreach($videodb as $video) { ?><tr class="text_center">
<td><?=$video[vid]?></td>
